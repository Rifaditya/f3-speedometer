...
### Fixed
- Fixed standing still velocity artifact (`1.57 m/s` / `1.nnn m/s`) caused by vanilla downward gravity acceleration when standing on blocks. Standing still now correctly displays `0.00 m/s`.
