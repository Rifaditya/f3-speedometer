...
## ⚡ Features
- **Native F3 Debug Entry**: Registered directly as `f3_speedometer:speedometer` within Minecraft 26.2's `DebugScreenEntries`.
...
- **Detailed Vector Breakdown**: Measures total 3D speed in m/s (blocks/second) along with horizontal (X/Z) and vertical (Y) components.
